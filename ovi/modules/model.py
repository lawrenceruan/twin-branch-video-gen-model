...
#         # Preserve text lengths so attention does not attend to padded tokens.
#         context_lens = torch.tensor(
#             [min(u.size(0), self.text_len) for u in context],
#             dtype=torch.long,
#             device=x.device,
#         )
...
#                     [
#                         u[:self.text_len],
#                         u.new_zeros(max(0, self.text_len - u.size(0)), u.size(1)),
#                     ]
#                 )
#                 for u in context
#             ])
